...
const updateUserAvatar = asyncHandler( async (req,res) => {
    // get user details from cookie using auth middleware
    // fetch avatar cloudinary link from user
    // upload the new file on diskStorage usinf multer
    // upload it on cloudinary
    // update in user
    // save the user
    // delete that file from cloudinary
    // send response
